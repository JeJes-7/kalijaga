<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <p class="text-gray-500 text-sm mt-1">
            Isi formulir di bawah untuk menambah data inventaris baru.
        </p>
    </x-slot>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kondisi" id="kondisi" value="{{ old('kondisi', 'Baik') }}" required
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="date" name="tanggal_tercatat" id="tanggal_tercatat" value="{{ old('tanggal_tercatat', date('Y-m-d')) }}" required
                                   class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
