                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kitab" id="kitab" value="{{ old('kitab', $jadwal->kitab) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="ustadz" id="ustadz" value="{{ old('ustadz', $jadwal->ustadz) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="waktu" id="waktu" value="{{ old('waktu', $jadwal->waktu) }}" required
