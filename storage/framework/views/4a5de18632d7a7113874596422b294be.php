...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col items-center mb-6">
        <img src="<?php echo e(asset('img/ponpes.png')); ?>" alt="Logo Ponpes" class="w-24 h-24 mb-4">
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-blue-600 hover:text-blue-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" href="<?php echo e(route('password.request')); ?>">
                    Lupa Password?
                </a>
            <?php endif; ?>
        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\ponpes_kalijaga\resources\views/auth/login.blade.php ENDPATH**/ ?>