    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white border border-blue-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($totalSantri); ?></p>
            ...
            <div class="bg-white border border-yellow-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($totalTunggakan); ?></p>
            ...
            <div class="bg-white border border-red-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($totalPelanggaran); ?></p>
            ...
            <div class="bg-white border border-green-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p class="text-3xl font-bold text-gray-900 mb-2">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></p>
...
<?php endif; ?><?php /**PATH C:\laragon\www\ponpes_kalijaga\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>