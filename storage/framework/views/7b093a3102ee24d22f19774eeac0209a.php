        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="space-y-1">
                    ...
                    <dd class="text-3xl font-bold text-gray-900"><?php echo e($totalSantriAktif); ?></dd>
                </div>

                <!-- Stat Total Pemasukan -->
                <div class="space-y-1">
                    <dt class="text-xs font-medium text-gray-500 uppercase">Total Pemasukan (All Time)</dt>
                    <dd class="text-3xl font-bold text-green-600">Rp <?php echo e(number_format($totalPemasukan, 0, ',', '.')); ?></dd>
                </div>
                
                <!-- Stat Pelanggaran Menunggu -->
                <div class="space-y-1">
                    <dt class="text-xs font-medium text-gray-500 uppercase">Pelanggaran Selesai</dt>
                    <dd class="text-3xl font-bold text-gray-900"><?php echo e($totalPelanggaranSelesai); ?></dd>
                </div>

                <!-- Stat Pelanggaran Menunggu -->
                <div class="space-y-1">
                    <dt class="text-xs font-medium text-gray-500 uppercase">Hukuman Menunggu</dt>
                    <dd class="text-3xl font-bold text-red-600"><?php echo e($totalPelanggaranMenunggu); ?></dd>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\ponpes_kalijaga\resources\views/admin/laporan/index.blade.php ENDPATH**/ ?>