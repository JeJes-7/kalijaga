...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <p class="text-gray-500 text-sm mt-1">
            Perbarui data jadwal ngaos.
        </p>
     <?php $__env->endSlot(); ?>

    <div class="space-y-6">
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
            <form action="<?php echo e(route('admin.jadwal.update', $jadwal)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="hari" id="hari" value="<?php echo e(old('hari', $jadwal->hari)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="kitab" id="kitab" value="<?php echo e(old('kitab', $jadwal->kitab)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="ustadz" id="ustadz" value="<?php echo e(old('ustadz', $jadwal->ustadz)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="waktu" id="waktu" value="<?php echo e(old('waktu', $jadwal->waktu)); ?>" required
...
<?php endif; ?><?php /**PATH C:\laragon\www\ponpes_kalijaga\resources\views/admin/jadwal/edit.blade.php ENDPATH**/ ?>