...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <p class="text-gray-500 text-sm mt-1">
            Isi formulir di bawah untuk mendaftarkan santri baru.
        </p>
     <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="kamar" id="kamar" value="<?php echo e(old('kamar')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_masuk" id="tanggal_masuk" value="<?php echo e(old('tanggal_masuk')); ?>" required
                                   class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_telpon" id="no_telpon" value="<?php echo e(old('no_telpon')); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\ponpes_kalijaga\resources\views/admin/santri/create.blade.php ENDPATH**/ ?>